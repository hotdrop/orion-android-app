# ORION
このアプリは、技術情報・技術ブログメモ・TODOを管理するための、近未来サイバーコンソールをテーマとした Android アプリです。
...
- 今週収集した技術情報を管理します。
- Google Drive上の技術レポートへのリンク
- 一覧表示する際のタイトル（ユーザーが入力）
- 技術レポートの概要（ユーザーが入力）

Google Driveの指定したフォルダを設定画面などで登録しておき、そこ定期的にパスとファイル名を自動的に取得したいです。
ファイル名はタイトルにデフォルト表示し、修正可能とします。
